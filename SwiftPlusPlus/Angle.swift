...
public struct Angle: Equatable, Comparable {
    ...
    public init(radians: Float) {
        self.value = Angle.normalized(value: radians, with: .radians)
        self.unit = .radians
    }
    ...
    public init(degrees: Float) {
        self.value = Angle.normalized(value: degrees, with: .degrees)
        self.unit = .degrees
    }
...
public func +(lhs: Angle, rhs: Angle) -> Angle {
    if lhs.unit == rhs.unit {
        return Angle(value: Angle.normalized(value: lhs.value + rhs.value, with: lhs.unit), unit: lhs.unit)
    }
    else {
        return Angle(radians: Angle.normalized(value: lhs.radians() + rhs.radians(), with: .radians))
    }
}
...
public func +=(lhs: inout Angle, rhs: Angle) {
    if lhs.unit == rhs.unit {
        ...
        lhs = Angle(radians: Angle.normalized(value: lhs.radians() + rhs.radians(), with: .radians))
    }
}
...
public func /(lhs: Angle, rhs: Float) -> Angle {
    return Angle(value: Angle.normalized(value: lhs.value / rhs, with: lhs.unit), unit: lhs.unit)
}
